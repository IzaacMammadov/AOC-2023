"""Day 7 - Problem 2 of Advent of Code 2023"""
...
def order(hand_to_consider):
    ...
    num_jokers = value_counts["J"]
    value_counts["J"] = 0
    max_value_card = max(value_counts, key=lambda card_value: value_counts[card_value], default="2")
    value_counts[max_value_card] += num_jokers
